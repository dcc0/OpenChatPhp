...
//Показать список каналов
    ...
    public function getChannels()
      {
/*LiMIT 10 - отображает только 10 каналов, остальные скрыты, нужно знать название канала*/
    $show_channels=$this->connection->query("SELECT DISTINCT chatname from chat LIMIT 15");
