 ...
 * Следующий текст следует читать вспоминая голос Гоблина:
 * "Когда я сел писать этот класс, я не знал, зачем я сел писать этот класс.
 * Возможно, я не совсем понимал, что я деалю и что должно получиться в конце. Но мне казалось, что я должен
 * написать этот класс, потому что я... *пауза*... просто должен написать этот класс".
 *
